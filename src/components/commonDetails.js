  ...
  return (
    <div className='flex flex-col space-y-6'>
      ...
      <div className='flex flex-col items-center space-x-4  p-2 border border-black/5 '>
        <div className='flex flex-col justify-between content-center items-center self-start'>
        ...
        <div className='flex flex-row items-center self-start'>
          <h1 className='text-[3rem] tracking-wider font-light '>${price}</h1>
          <p className='tracking-wider' style={{ color: parseFloat(change) > 0 ? '#00cc00' : '#ff6666' }}><span> <FontAwesomeIcon icon={parseFloat(change) > 0 ? faAngleUp : faAngleDown} /> </span> {parseFloat(change)}%</p>
        </div>
      </div>
      <div className=''>
